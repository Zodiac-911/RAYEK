...
function ProfileGreenFlags({ username }) {
  return (
    <>
      <div className="content-container profile-gf-container">
        <div className="profile-gf-header">
          <h2>
            <span>{username}</span>'s Green Flags
          </h2>
        </div>
        <PostCard
          userIMG={userIMG1}
...
export default ProfileGreenFlags;
